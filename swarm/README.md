...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/ethereumprogpow/ethereumprogpow

    go install github.com/ethereumprogpow/ethereumprogpow/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/ethereumprogpow/ethereumprogpow`.

Most likely you will be working from your fork of `ethereumprogpow`, let's say from `github.com/nirname/ethereumprogpow`. Clone or move your fork into the right place:

```
git clone git@github.com:nirname/ethereumprogpow.git $GOPATH/src/github.com/ethereumprogpow/ethereumprogpow
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/ethereumprogpow/ethereumprogpow/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/ethereumprogpow/ethereumprogpow/wiki/Code-Review-Guidelines).
