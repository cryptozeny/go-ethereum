...
// This test reproduces https://github.com/ethereumprogpow/ethereumprogpow/issues/17837 where the
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("ethereumprogpow-test-ipc-%d-%d", os.Getpid(), rand.Int63())
