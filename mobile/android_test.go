...
import org.ethereumprogpow.geth.*;
...
public class AndroidTest extends InstrumentationTestCase {
	...
	// signatures too. Regression test for ethereumprogpow issue #14599.
...
func TestAndroid(t *testing.T) {
	...
	gobind := exec.Command("gomobile", "bind", "-javapkg", "org.ethereumprogpow", "github.com/ethereumprogpow/ethereumprogpow/mobile")
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
          package="org.ethereumprogpow.gethtest"
