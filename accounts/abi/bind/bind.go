...
//
// Detailed usage document and tutorial available on the ethereumprogpow Wiki page:
// https://github.com/ethereumprogpow/ethereumprogpow/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
