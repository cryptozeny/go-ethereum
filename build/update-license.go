...
var (
	...
	authorsFileHeader = "# This is the official list of ethereumprogpow authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The ethereumprogpow Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "ethereumprogpow"
	}
	if startOfSentence {
		return "The ethereumprogpow library"
	}
	return "the ethereumprogpow library"
}
