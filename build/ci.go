...
func doInstall(cmdline []string) {
	...
	if !strings.Contains(runtime.Version(), "devel") {
		...
		if minor < 9 {
			...
			log.Println("ethereumprogpow requires at least Go version 1.9 and cannot")
...
type debMetadata struct {
	...
	// ethereumprogpow version being built. Note that this
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereumprogpow", "-v", "github.com/ethereumprogpow/ethereumprogpow/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "github.com/ethereumprogpow/ethereumprogpow/mobile")
