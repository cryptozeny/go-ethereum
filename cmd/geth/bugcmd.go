...
const issueURL = "https://github.com/ethereumprogpow/ethereumprogpow/issues/new"

// reportBug reports a bug by opening a new URL to the ethereumprogpow GH issue
